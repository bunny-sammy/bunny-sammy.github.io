...
export default memo(function Header () {
    ...
    const dynamicStyles = {
        ...
        "--user-transform": `translate(${width * (0.25 * (1-modifier)) - 65*(1-modifier)}px, ${10 * (1-modifier)}px)`,
        "--name-transform": `scale(${Math.max(0.6, 1-modifier)}, ${Math.max(0.6, 1-modifier)}) translate(-${modifier > 0.01 ? (width * (0.2 * modifier)) : 0}px, -${modifier > 0.01 ? (100 * modifier) : 0}px)`,
